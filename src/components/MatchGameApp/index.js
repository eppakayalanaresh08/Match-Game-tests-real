...
class MatchGameApp extends Component {
  ...
  onClickNamesItems = tabId => {
    this.setState({ListTabImage: tabId})
  }

  getListItems = () => {
    const {ListTabImage} = this.state
    const listNamesTab = imagesList.filter(
      eachTabName => eachTabName.category === ListTabImage,
    )
    return listNamesTab
  }
  ...
  render() {
    const {ListTabImage, gameIsOver, points, time, randomImage} = this.state
    console.log(randomImage)
    const listContainerItems = this.getListItems(ListTabImage)
    return (
      <div className="bg-container">
        <nav className="card-game-bg-container">
          <img
          ...
          <ul className="score-container">
            <li className="list-score-items">
              <p className="score-Element">
                Score: <span className="only-nav-item">{points}</span>
              </p>
            </li>
            <img
            ...
            />
            <li className="list-score-items">
              <p className="time-Element">{time} sec</p>
            </li>
          </ul>
        </nav>
          ...
          {gameIsOver ? (
            <div className="container-game-over">
              <img
                ...
                alt="trophy"
                className="trophy-Element"
              />
              <p className="Your-Score-game-over">YOUR SCORE</p>
              <p className="game-score">{points}</p>
            ...
            <div className="container-images-thumbnail">
              <img
                src={randomImage.imageUrl}
                alt="match"
                className="images-Game"
              />
              <ul className="lists-items-buttons">
              ...
              <ul className="container-ThumbnailImage">
                {listContainerItems.map(eachItemObject => (
                  <ThumbnailImage
                    eachList={eachItemObject}
                    key={eachItemObject.id}
                    onEachThumbnail={this.onEachThumbnail}
                  />
                ))}
              </ul>
            </div>
